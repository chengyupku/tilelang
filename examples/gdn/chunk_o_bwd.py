...
@tilelang.jit(out_idx=[9, 10, 11, 12], pass_configs={tilelang.PassConfigKey.TL_DISABLE_TMA_LOWER: True, tilelang.PassConfigKey.TL_DISABLE_WARP_SPECIALIZED: True})
...
def run_test(
    ...
    tilelang_time = do_bench(kernel, Q, K, V, h, G, dO, dh, dv, W)
