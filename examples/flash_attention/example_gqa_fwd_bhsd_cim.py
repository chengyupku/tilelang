"""CIM GQA Flash Attention BHSD with separate seq_q / seq_kv support.

Based on example_gqa_fwd_bhsd_baseline.py with cim_simulate=True on both T.gemm calls.
...
def flashattn_cim(batch, heads, seq_q, seq_kv, dim, is_causal, groups=1,
...
def main(
    ...
    kernel = flashattn_cim(batch, heads, seq_q, seq_kv, dim, is_causal, groups=groups,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="CIM GQA Flash Attention BHSD (supports seq_q != seq_kv)")
