...
extern "C" __global__ void __launch_bounds__(384) non_split_kv_kernel(__grid_constant__ const CUtensorMap KV_desc, __grid_constant__ const CUtensorMap K_pe_desc, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap Q_pe_desc) {
    ...
    for (int k_1 = 0; k_1 < 128; ++k_1) {
      ...
      for (int i_3 = 0; i_3 < 8; ++i_3) {
        for (int vec_1 = 0; vec_1 < 2; ++vec_1) {
          acc_s_0[((i_3 * 2) + vec_1)] = 0.000000e+00f;
        }
      }
      tl::fence_proxy_async();
      tl::mbarrier_wait(_mbarrier[(k_1 & 1)], ((k_1 & 3) >> 1));
      tl::gemm_ss<64, 64, 512, 4, 2, 0, 1>((&(((half_t*)buf_dyn_shmem)[16384])), (&(((half_t*)buf_dyn_shmem)[(((k_1 & 1) * 32768) + 49152)])), (&(acc_s_0[0])));
      tl::mbarrier_wait(_mbarrier[((k_1 & 1) + 2)], ((k_1 & 3) >> 1));
      tl::gemm_ss<64, 64, 64, 4, 2, 0, 1>((&(((half_t*)buf_dyn_shmem)[0])), (&(((half_t*)buf_dyn_shmem)[(((k_1 & 1) * 4096) + 8192)])), (&(acc_s_0[0])));
      #pragma unroll
      ...
      for (int i_6 = 0; i_6 < 2; ++i_6) {
        tl::ptx_stmatrix_x4((&(((half_t*)buf_dyn_shmem)[((((((((((int)threadIdx.x) & 127) >> 5) * 1024) + ((((int)threadIdx.x) & 15) * 64)) + ((((int)threadIdx.x) >> 7) * 32)) + (i_6 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) + 4096)])), __pack_half2(((half_t)acc_s_0[(i_6 * 8)]), ((half_t)acc_s_0[((i_6 * 8) + 1)])), __pack_half2(((half_t)acc_s_0[((i_6 * 8) + 2)]), ((half_t)acc_s_0[((i_6 * 8) + 3)])), __pack_half2(((half_t)acc_s_0[((i_6 * 8) + 4)]), ((half_t)acc_s_0[((i_6 * 8) + 5)])), __pack_half2(((half_t)acc_s_0[((i_6 * 8) + 6)]), ((half_t)acc_s_0[((i_6 * 8) + 7)])));
      }
      tl::syncthreads_partial(_mbarrier[8]);
      #pragma unroll
      for (int i_7 = 0; i_7 < 16; ++i_7) {
        float2 __1;
        uint1 v_ = *(uint1*)(((half_t*)buf_dyn_shmem) + ((((((((((int)threadIdx.x) & 127) >> 5) * 1024) + ((i_7 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_7 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 4096));
      ...
      tl::fence_proxy_async();
      tl::gemm_rs<64, 512, 64, 4, 2, 0, 0>((&(acc_s_cast[0])), (&(((half_t*)buf_dyn_shmem)[(((k_1 & 1) * 32768) + 49152)])), (&(acc_o[0])));
