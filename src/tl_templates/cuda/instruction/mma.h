...
// CIM simulation: replace all B register values with the address of b[0].
// This models CIM hardware where B data resides in-memory and only an
// address hook is passed to the MMA instruction.
template <class Impl, size_t... DIdx, size_t... AIdx, size_t... BIdx,
          size_t... CIdx>
